...
import { selectValueScopeAndVariables } from '../state-store/selectors/mirror.selector';
...
export abstract class DynamicComponent implements AfterViewInit, OnDestroy {
    ...
    public async ngAfterViewInit(): Promise<void> {
        // initialize接口实现判断
        if (this['initialize'] && this['parameters']) {
            ...
            // console.log('initialze', variables);

        }
        // 渲染子组件
        if (this.dynamicComponentContainer.size && this.metaData.content?.length) {
